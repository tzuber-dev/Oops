...
This is one of the labs where you are not required to write unit tests, due to the while loop which governs the program. It is entirely possible to unit test this app with Catch2, but it requires more advanced techniques that we will not cover in this course.
...
[more-than-equations]: https://morethanequations.com/Computer-Science/Labs/Oops!-Shall-We-Try-Again
